...
export default function ObjectState() {
  ...
  const onSubmit = useCallback(
    (e: FormEvent<HTMLFormElement>) => {
      ...
      setForm((form) => ({ ...form, name: "", email: "" })); // input box 초기화
    },
    [form]
  );
      ...
      <div className="flex justify-center mt-4">
        <form onSubmit={onSubmit}>
          <div className="form-control">
            ...
            <input value={form.name} onChange={onChangeName} id = "name" type="text" placeholder="enter your name" 
          ...
          <label className="label" htmlFor="email">
            ...
            <input value={form.email} onChange={onChangeEmail} id = "email" type="email" placeholder="enter your email" 
            className="input input-primary"/>
          </div>
          <div className="flex justify-center mt-4">
